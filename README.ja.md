...
再学習ダッシュボードまで含む 90 秒のサブミッション動画:

https://github.com/user-attachments/assets/05940f58-c9bb-46ed-bf07-6512c4c1f500

> リポジトリ内の MP4 は [`docs/demo-30s.mp4`](./docs/demo-30s.mp4) /
> [`docs/demo-90s.mp4`](./docs/demo-90s.mp4)。上の埋め込み URL は
> GitHub の user-attachments にアップロードしたもの — README は
> `<video>` タグを strip するので、インライン再生にはこの形式が必要。
